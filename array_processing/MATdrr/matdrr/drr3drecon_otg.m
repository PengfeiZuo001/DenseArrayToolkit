function [ D1, D2 ] = drr3drecon_otg(D,x,y,nx,ny,ox,oy,mx,my,flow,fhigh,dt,N,K,Niter,eps,verb,mode,a)
...
%       a:      weight vector
%
%  OUT  D1:  	output data on regular grid
%       D2:     output data on original grid
%
...
D2 = zeros(size(D));
for n = 1:size(D1,1)
    D2(n,:)=inter_op(squeeze(D1(n,:,:)),par,-1);
end
return
